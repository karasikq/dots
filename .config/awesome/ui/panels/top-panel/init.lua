...
kbdcfg.add_primary_layout("Russian",  "🇧🇾", "ru")
kbdcfg.bind()


awful.keyboard.append_global_keybindings({
  awful.key({"Mod4"}, "Control_L", function () kbdcfg.switch_next() end, { description = "switch keyboard layout", group = "WM" })
})
...
return function(s)
	...
	local function keyboard_layout_panel()
